...
train_history = model.fit([X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14], y1, epochs=120, batch_size=64, verbose=1,validation_data=([X1_test,X2_test,X3_test,X4_test,X5_test,X6_test,X7_test,X8_test,X9_test,X10_test,X11_test,X12_test,X13_test,X14_test], y1_test))
...
y1_test1 = scaler16.inverse_transform(y1_test)
