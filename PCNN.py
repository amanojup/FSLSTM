...
#layer5 = Conv2D(filters=flters_no1, kernel_size=(2, 2), data_format='channels_last',kernel_regularizer = regularizers.l2(0.01), bias_regularizer = regularizers.l2(0.01),activation='relu', padding='same')(spe_input1)
k1 = Conv2D(16, (3, 3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform')(spe_input1)
k1 = BatchNormalization()(k1)
k2 = Conv2D(16, (3, 3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform')(k1)
k2 = BatchNormalization()(k2)
k3 = Conv2D(16, (3, 3),strides=(1,1),activation='relu', padding='same', kernel_initializer='he_uniform')(k2)
#k1 = BatchNormalization()(k1)
#x2 = TimeDistributed(Dropout(0.001))(x2)
flat1 = Flatten()(k3)
