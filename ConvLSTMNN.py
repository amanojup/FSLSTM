...
#k2= ConvLSTM2D(5, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(k1)
...
train_history = model.fit(X1, y1, epochs=120, batch_size=64, verbose=1,validation_data=(X1_test, y1_test))
print(X1.shape)
print(y1.shape)
#print(X1)
#print(y1)
