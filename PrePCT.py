...
from keras.layers import Conv1D, Conv2D,TimeDistributed, MaxPooling2D,MaxPooling3D, ConvLSTM2D, Conv3D,LSTM, AveragePooling2D, AveragePooling3D
...
# load the new file
target = pd.read_csv('IStargetSExFlow.csv', header=0, infer_datetime_format=True, parse_dates=['datetime'], index_col=['datetime'])
print(target.head())
print(target.shape)
# save
#spe.to_csv('speedcat.csv')
...
k1 = ConvLSTM2D(10, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(spe_input1)
#k1 = BatchNormalization()(k1)
#k2= ConvLSTM2D(10, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(k1)
#k2 = BatchNormalization()(k2)
#k3= ConvLSTM2D(10, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(k2)
#k3 = BatchNormalization()(k3)
#k4= ConvLSTM2D(10, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(k3)
#k4 = BatchNormalization()(k4)
#k5= ConvLSTM2D(10, (3,3),strides=(2,2),activation='relu', padding='same', kernel_initializer='he_uniform',return_sequences=True,dropout=0.001)(k4)
#k5 = BatchNormalization()(k5)
#layer4 = BatchNormalization()(layer4)
#layer5 = Conv2D(filters=flters_no1, kernel_size=(3, 3), data_format='channels_last',kernel_regularizer = regularizers.l2(0.01), bias_regularizer = regularizers.l2(0.01),activation='relu', padding='same')(layer4)
...
train_history = model.fit(X1, y1, epochs=110, batch_size=64, verbose=1,validation_data=(X1_test, y1_test))
print(X1.shape)
print(y1.shape)
#print(X1)
#print(y1)
