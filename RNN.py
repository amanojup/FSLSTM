...
from keras.layers import Conv2D,Conv1D,GRU, MaxPooling2D, ConvLSTM2D, Conv3D,LSTM
...
layer1 = SimpleRNN((flters_no1), activation='relu', return_sequences=False)(spe_input1)
...
train_history = model.fit(X1, y1, epochs=130, batch_size=64, verbose=1,validation_data=(X1_test, y1_test))
#print(X1.shape)
#print(y1.shape)
#print(X1)
#print(y1)
